...
const EditBuyer = (props) => {
    ...
    useEffect(() => {
        ...
        axios({
            url: baseURL+"/web-fetch-buyer-by-id/" + params.id,
            method: "GET",
            headers: {
    ...
    const onUpdate = (e) => {
        ...
        axios({
            url: baseURL+"/web-update-buyer/"+ params.id,
            method: "PUT",
            data,
            headers: {
            Authorization: `Bearer ${localStorage.getItem("login")}`,
            ...
            if(res.data.code == '200'){
                NotificationManager.success("Buyer Updated Sucessfully");
                history.push("/buyer");
            }else{
    ...
    return(
        <div>
            <div className="page-header">
                <h3 className="page-title"> Edit Buyer </h3>
            </div>
            <div className="row">
